...
//This function accepts a path name and obtains a relative path name to the directory
//in essence it removes the origin directory name and returns only the path that follows it
char * getrelativepath(char *);
